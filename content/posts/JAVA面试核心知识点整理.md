...
![JVM内存区域](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/JVM内存区域.jpg)
...
![JAVA_NIO包](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/JAVA_NIO包.jpg)
...
![集合框架](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/集合框架.jpg)
...
- Semaphore 可以用来构建一些对象池，资源池之类的，比如数据库连接池实现互斥锁（计数器为1） 
...
![线程上下文切换](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/线程上下文切换.jpg)
...
![线程池的组成](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/线程池的组成.jpg)
...
![Java阻塞队列原理](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Java阻塞队列原理.jpg)

2. 当队列中填满数据的情况下，生产者端的所有线程都会被自动阻塞（挂起），直到队列中有空的位置，线程被自动唤醒。

![Java阻塞队列原理2](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Java阻塞队列原理2.jpg)

**阻塞队列的主要方法** 

![阻塞队列的主要方法](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/阻塞队列的主要方法.jpg)
...
![阻塞队列家族](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/阻塞队列家族.jpg)
...
- 比**sychronized** 更轻量级的同步锁 在访问 volatile 变量时不会执行加锁操作，因此也就不会使执行线程阻塞，因此 volatile 变量是一种比 sychronized 关键字更轻量级的同步机制。
- volatile 适合这种场景：一个变量被多个线程共享，线程直接给这个变量赋值。 

![禁止指令重排序](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/禁止指令重排序.jpg)
...
2. 该变量没有包含在具有其他变量的不变式中，也就是说不同的 volatile 变量之间，不能互相依赖。只有在状态真正独立于程序内其他内容时才能使用 volatile。 
...
![ThreadLocalMap](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/ThreadLocalMap.jpg)
...
![ConcurrentHashMap](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/ConcurrentHashMap.jpg)
...
![线程调度](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/线程调度.jpg)
...
![高响应比优先调度算法](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/高响应比优先调度算法.jpg)
...
![CAS](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/CAS.jpg)
...
![AQS](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/AQS.jpg)
...
![Java异常分类及处理](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Java异常分类及处理.jpg)
...
2. **Exception**（RuntimeException、CheckedException） ：Exception又有两个分支

   1. 运行时异常：RuntimeException，如 ： NullPointerException 、 ClassCastException ；，如 I/O 错误导致的 IOException、SQLException。 RuntimeException 是那些可能在 Java 虚拟机正常运行期间抛出的异常的超类。 如果出现 RuntimeException，那么一定是程序员的错误. 

   2.  一 个是检查异常：CheckedException。 
...
![反射机制概念](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/反射机制概念.jpg)
...
![JAVA注解](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/JAVA注解.jpg)
...
直接赋值。在 Java 中，A a1 = a2，我们需要理解的是这实际上复制的是引用，也就是说 a1 和 a2 指向的是同一个对象。因此，当 a1 变化的时候，a2 里面的成
员变量也会跟着变化。 
...
![Spring特点](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Spring特点.jpg)

##  **Spring** 核心组件 

![Spring核心组件](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Spring核心组件.jpg)

##  **Spring** 常用模块 

![Spring常用模块](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Spring常用模块.jpg)

## **Spring** 主要包 

![Spring主要包](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Spring主要包.jpg)

## **Spring** 常用注解 

bean 注入与装配的的方式有很多种，可以通过 xml，get set 方式，构造函数或者注解等。简单易用的方式就是使用 Spring 的注解了，Spring 提供了大量的注解方式。 

![Spring常用注解](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Spring常用注解.jpg)

##  **Spring** 第三方结合 

![Spring第三方结合](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Spring第三方结合.jpg)
...
![Spring容器高层视图](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Spring容器高层视图.jpg)
...
![IOC容器实现](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/IOC容器实现.jpg)
...
![ApplicationContext类继承体系](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/ApplicationContext类继承体系.jpg)
...
![WebApplication体系架构](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/WebApplication体系架构.jpg)
...
![Bean生命周期](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Bean生命周期.jpg)
...
![AOP重要概念](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/AOP重要概念.jpg)
...
![AOP实现原理](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/AOP实现原理.jpg)
...
![MVC流程](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/MVC流程.jpg)
...
![MVC常用注解](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/MVC常用注解.jpg)
...
![两阶段提交](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/两阶段提交.jpg)
...
![Mybatis缓存](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Mybatis缓存.jpg)
...
![客户端注册](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/zookeeper.jpg)
...
![服务端发现](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/服务端发现.jpg)
...
![API网关](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/API网关.png)
...
![zookeeper配置中心](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/zookeeper配置中心.jpg)

 配置中心数据分类 

![配置中心数据分类](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/配置中心数据分类.jpg)
...
![服务熔断](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/服务熔断.jpg)
...
![多路复用通讯方式](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/多路复用通讯方式.jpg)

客户端通信序列图如下：

![客户端通信序列图](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/客户端通信序列图.jpg)
...
![Reactor单线程模型](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Reactor单线程模型.jpg)
...
![Reactor多线程模型](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Reactor多线程模型.jpg)
...
![主从Reactor多线程模型](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/主从Reactor多线程模型.jpg)
...
![无锁设计_线程绑定](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/无锁设计_线程绑定.jpg)
...
![NettyRpc实现](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/NettyRpc实现.jpg)
...
![核心流程](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/核心流程.png)
...
![通讯过程](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/通讯过程.png)
...
![ProtoclolBuffer特点](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/ProtoclolBuffer特点.jpg)
...
![Thrift](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Thrift.jpg)

#  网络 

## 网络7层架构 

![img](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/clip_image002.jpg)
...
![TCP_IP原理](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/TCP_IP原理.jpg)
...
![数据包说明](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/数据包说明.jpg)
...
![三次握手](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/三次握手.jpg)
...
![4次挥手](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/4次挥手.jpg)
...
![高层数据](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/高层数据.jpg)
...
![HTTPS](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/HTTPS.jpg)
...
![管理系统](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/管理系统.jpg)
...
![ELK](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/ELK.png)
...
![Observer](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Observer.png)
...
`s1`收到客户端的写请求将值设置为x，最终成功

![image-20220921004755410](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/image-20220921004755410.png)



### 例子2

`s1`提案1被Acceptors接受，然后`s5`的提案2随后也会被接受

![image-20220921004949725](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/image-20220921004949725.png)
...
![image-20220921005339512](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/image-20220921005339512.png)



### 例子4

s1提案1失败，s5提案2成功，后面s1的提案3也会成功

![image-20220921004030553](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/image-20220921004030553.png)
...
![Kafka](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Kafka.png)
...
![Kafka数据存储设计](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Kafka数据存储设计.jpg)
...
![生产者设计](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/生产者设计.jpg)
...
![消费者设计](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/消费者设计.jpg)
...
![RabbitMQ架构](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/RabbitMQ架构.png)
...
![Direct键分布](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Direct键分布.png)

**Fanout（广播分发）**

2. Fanout：每个发到 fanout 类型交换器的消息都会分到所有绑定的队列上去。很像子网广播，每台子网内的主机都获得了一份复制的消息。fanout 类型转发消息是最快的。 

![Fanout（广播分发）](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Fanout（广播分发）.png)
...
![topic交换器](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/topic交换器.jpg)
...
![Hbase核心架构](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Hbase核心架构.jpg)
...
![Region寻址方式](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Region寻址方式.jpg)
...
![Hbase的写逻辑](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Hbase的写逻辑.jpg)
...
![MongoDB概念](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/MongoDB概念.png)
...
![Cassandra一致Hash和虚拟节点](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Cassandra一致Hash和虚拟节点.jpg)
...
![协调者](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/协调者.jpg)
...
![数据读请求和后台修复](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/数据读请求和后台修复.jpg)
...
![二级索引](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/二级索引.jpg)
...
![数据读取](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/数据读取.png)

行缓存和键缓存请求流程图 

![行缓存和键缓存请求流程图](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/行缓存和键缓存请求流程图.png)
...
![四层负载均衡vs七层负载均衡](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/四层负载均衡vs七层负载均衡.jpg)
...
![ipvs](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/ipvs.jpg)
...
![LVS_NAT模式](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/LVS_NAT模式.jpg)
...
![LVS_DR模式](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/LVS_DR模式.jpg)
...
![LVS_TUN模式](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/LVS_TUN模式.jpg)
...
![LVS_FULLNAT模式](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/LVS_FULLNAT模式.jpg)
...
![TokuDB](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/TokuDB.jpg)
...
![1stNF](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/1stNF.jpg)

**第二范式(2nd NF－每个表只描述一件事情)**

首先满足第一范式，并且表中非主键列不存在对主键的部分依赖。 第二范式要求每个表只描述一件事情。 

![2ndNF](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/2ndNF.jpg)

**第三范式(3rd NF－ 不存在对非主键列的传递依赖)** 

 第三范式定义是，满足第二范式，并且表中的列不存在对非主键列的传递依赖。除了主键订单编号外，顾客姓名依赖于非主键顾客编号。

![3rdNF](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/3rdNF.jpg)
...
![垂直切分](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/垂直切分.jpg)

水平切分***(\***按照规则划分存储***)\***

§  当一个表中的数据量过大时，我们可以把该表的数据按照某种规则，例如 userID 散列，进行划分，然后存储到多个结构相同的表，和不同的库上。

![水平切分](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/水平切分.jpg)
...
三阶段提交 (Three-phase commit)， 也 叫 三阶段提交协议 （ Three-phase commit protocol），是二阶段提交（2PC）的改进版本。 
...
![柔性事务](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/柔性事务.jpg)

3、 通过将一系列同步的事务操作变为基于消息执行的异步操作, 避免了分布式事务中的同步阻塞操作的影响。 

![异步事务](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/异步事务.jpg)
...
![NWR](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/NWR.jpg)
...
![一致性Hsh原理](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/一致性Hsh原理.jpg)
...
![映射关系](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/映射关系.jpg)
...
![插入排序算法1](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/插入排序算法1.jpg)

![插入排序算法2](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/插入排序算法2.jpg)
...
![快速排序算法](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/快速排序算法.jpg)
...
![希尔排序算法](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/希尔排序算法.jpg)
...
![归并排序算法](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/归并排序算法.jpg)
...
![剪枝算法](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/剪枝算法.jpg)
...
![最小生成树算法](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/最小生成树算法.jpg)
...
![插入操作](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/插入操作.jpg)
...
![删除操作](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/删除操作.jpg)
...
![左旋](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/左旋.jpg)
...
![添加](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/添加.jpg)
...
![删除](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/删除.jpg)
...
![B树](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/B树.jpg)
...
![B+Tree](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/B+Tree.jpg)
...
![AES](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/AES.jpg)
...
![RSA](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/RSA.jpg)

![RSA2](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/RSA2.jpg)
...
![MapReduce](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/MapReduce.jpg)
...
![Map_Task执行流程](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Map_Task执行流程.jpg)
...
![Spark](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Spark.jpg)
...
![核心组件](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/核心组件.jpg)
...
![SPARK编程模型](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/SPARK编程模型.jpg)
...
![SPARK计算模型](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/SPARK计算模型.jpg)

##  **SPARK** 运行流程 

![SPARK运行流程](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/SPARK运行流程.jpg)
...
![SPARK_RDD流程](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/SPARK_RDD流程.jpg)
...
![Transformation](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Transformation.jpg)

行动（Action）：Action 算子会触发 Spark 提交作业（Job），并将数据输出 Spark 系统。

![Action](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Action.jpg)
...
![集群架构](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/集群架构.jpg)
...
![编程模型](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/编程模型.jpg)
...
![Topology运行](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Topology运行.jpg)
...
是最终运行 spout 或 bolt 中代码的单元（注：1 个 task 即为 spout 或 bolt 的 1 个实例， executor 线程在执行期间会调用该 task 的 nextTuple 或 execute 方法）。topology 启动后，1 个 component(spout 或 bolt)的 task 数目是固定不变的，但该 component 使用的 executor 线程数可以动态调整（例如：1 个 executor 线程可以执行该 component 的 1 个或多个 task 实例）。这意味着，对于 1 个 component 存在这样的条件：#threads<=#tasks（即：线程数小于等于 task 数目）。默认情况下 task 的数目等于 executor 线程数目，即 1 个 executor 线程只运行 1 个 task。 
 ...
 ![Task](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Task.jpg)

**Storm Streaming Grouping** 

Storm 中最重要的抽象，应该就是 Stream grouping 了，它能够控制 Spot/Bolt 对应的 Task 以什么样的方式来分发 Tuple，将 Tuple 发射到目的 Spot/Bolt 对应的 Task. 

![StormStreamingGrouping](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/StormStreamingGrouping.jpg)
...
![概念](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/概念.png)
...
![YARN运行流程](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/YARN运行流程.png)
...
![云计算](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/云计算.jpg)
...
![Docker](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/Docker.png)
...
![DOCKER_NETWORK](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/DOCKER_NETWORK.jpg)
...
![DOCKER_NETWORK_TOPOLOGY](06-JAVA面试核心知识点整理(时间较多的同学全面复习)/DOCKER_NETWORK_TOPOLOGY.jpg)
